...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantClasses = {
      primary: 'bg-primary-default text-stone-950 hover:bg-primary-hover focus:bg-primary-hover',
      secondary:
      ...
      ghost: 'text-fg-default hover:bg-bg-surface focus:bg-bg-surface',
      destructive: 'bg-etc-red text-white hover:bg-red-600 focus:bg-red-600',
    }
    ...
    return (
      ...
      >
        ...
        <span className={cn(loading && 'ml-2', !loading && leftIcon && 'ml-1.5')}>{children}</span>
